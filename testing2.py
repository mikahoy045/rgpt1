...
class RabbitMQBroker:
    ...
    async def connect(self):
        try:
            ...
            self.rabbitmq_queue = await self.channel.declare_queue(self.queue_name, durable=True)
            await self.rabbitmq_queue.bind(self.exchange, routing_key=self.routing_key)
...
async def main():
    ...
    await rabbitmq_broker.publish("Hello, World!", correlation_id="1234")
